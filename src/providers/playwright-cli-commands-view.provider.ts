...
export class PlaywrightCliCommandsViewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = "playwright-helpers.playwright-cli-commands";
